...
async function load_model() {
    ...
    //const model = await loadGraphModel("http://127.0.0.1:8080/tfjs-inari/models/model.json");	
    ...
    const model = await loadGraphModel("https://raw.githubusercontent.com/liyanaayusoff/cat-detection/blob/main/model.json");	
